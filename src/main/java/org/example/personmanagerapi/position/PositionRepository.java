...
public interface PositionRepository extends JpaRepository<Position, Long> {
    ...
    boolean existsOverlappingPosition(@Param("employeeId") UUID employeeId, @Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);

    void deleteByIdAndEmployeeId(Long positionId, UUID employeeId);
}
